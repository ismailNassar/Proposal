...
\subsection{Optimized Platforms for the Emission from a QD} \label{OptmizedPlatforms}
Quantum optic technologies require a bright source of entangled photons. The emission from a QD is enhanced by placing it in photonic structures such as a cavity. This leads to a higher Purcell factor and increases signal extraction efficiency. An emerging approach is using circular Bragg grating (CBG)\cite{Davan̤o2011}, which can obtain an extraction efficiency above 90\% and a Purcell factor higher than 20\cite{Jian-Wei2019}.\\
